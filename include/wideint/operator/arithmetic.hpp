#ifndef WIDEINT_OPERATOR_ARITHMETIC_HPP
#define WIDEINT_OPERATOR_ARITHMETIC_HPP
...
template <std::size_t N, bool Signed>
WIDEINT_HD inline basic_int<N, Signed> operator+(const basic_int<N, Signed> &value) {
    return value;
}

template <std::size_t N, bool Signed>
WIDEINT_HD inline basic_int<N, Signed> operator-(basic_int<N, Signed> value) {
    negate_assign(value.limbs);
    return value;
}

template <std::size_t N, bool Signed>
WIDEINT_HD inline basic_int<N, Signed> operator~(basic_int<N, Signed> value) {
    bit_not_assign(value.limbs);
    return value;
}
...
#endif // WIDEINT_OPERATOR_ARITHMETIC_HPP
